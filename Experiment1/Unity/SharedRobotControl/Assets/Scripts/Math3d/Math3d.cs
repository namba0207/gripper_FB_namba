...
public class Math3d : MonoBehaviour {
    ...
    public static Quaternion AverageQuaternion(ref Vector4 cumulative, Quaternion newRotation, Quaternion firstRotation, int addAmount, float weight = 1f){
        float w = 0.0f;
        float x = 0.0f;
        float y = 0.0f;
        float z = 0.0f;
        ...
        //Average the values
        float addDet = 1f/(float)addAmount * weight;
